...
//FF Colors
#define FIRST_COLOR [UIColor colorWithRed:82.0f/255 green:115.0f/255 blue:249.0f/255 alpha:1].CGColor
#define SECOND_COLOR [UIColor colorWithRed:250.0f/255 green:111.0f/255 blue:4.0f/255 alpha:1].CGColor

//PME Colors
//#define FIRST_COLOR [UIColor colorWithRed:0.0f/255 green:140.0f/255 blue:0.0f/255 alpha:1].CGColor
//#define SECOND_COLOR [UIColor whiteColor].CGColor
...
//    strokeAnim.fromValue         = (id) FIRST_COLOR;
//    strokeAnim.toValue           = (id) SECOND_COLOR;
//    strokeAnim.duration          = 1.5f;
//    strokeAnim.repeatCount       = INFINITY;
//    strokeAnim.autoreverses      = YES;
//    [self.progressLayer addAnimation:strokeAnim forKey:@"animateStrokeColor"];
